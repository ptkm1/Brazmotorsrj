      ...
      <Container>
        ...
        <SecondSection>
          ...
          <CardContainerHome>
            ...
            <CardsInfoBot>
                <span><BiDollar /><IoCarSport /></span>
                <h1>Venda seu carro</h1>
                <p>A maneira mais rápida de vender seu carro, velocidade e segurança na hora de negociar.</p>
            </CardsInfoBot>
            <CardsInfoBot>
                <span><RiToolsFill /><IoCarSport /></span>
                <h1>Pós-Venda</h1>
                <p>Deseja agendar algum serviço? Só clicar no link do serviço desejado e preencher o formulário.</p>
            </CardsInfoBot>
          </CardContainerHome>
